...
def transform_fact_cancellation(s3_bucket: str):
    ...
    df_final = df_flat.withColumns(
        {
            ...
            "DimOrderKey":
                f.hash(f.lit("Cancellation"), f.col("InvoiceNo"), f.col("SourceSystem"))
        }
    )
    ...
    (
        ...
        .write
        .mode("overwrite")
        .parquet(f"s3a://{s3_bucket}/silver/fact_cancellation/v1")
    )
